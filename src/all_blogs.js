...
for(var i = 1; i<14; i++){
    ...
    allBlogsData.push({
        img: {
            src: `./assets/placeholder_${imgIndex}.jpg`
        },
        data: {
            date: "July 4, 2021",
            author: "Prashant Goyal",
